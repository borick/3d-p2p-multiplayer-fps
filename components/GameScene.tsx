...
// Simple Box for obstacles (re-implementing correctly for physics context)
  ...
  return (
    <Canvas shadows camera={{ fov: 75 }}>
      ...
      <Physics gravity={[0, -15, 0]}>
        <Ground />
        {/* Render obstacles again inside physics for collision - Sync with World.tsx manually for now */}
